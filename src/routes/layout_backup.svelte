<script>
  ...
  import "@/app.css";
	...
	const togglePagesMenu = () => (isPagesMenuOpen = !isPagesMenuOpen);
	const toggleProfileMenu = () => (isProfileMenuOpen = !isProfileMenuOpen);
	const closeProfileMenu = () => (isProfileMenuOpen = false);
...
>
						...
						{#if isPagesMenuOpen}
							...
							>
								...
								<li
									class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
								>
									<a class="w-full" href="./blank.html"
										>Blank</a
									>
								</li>
							</ul>
	...
	<div class="flex flex-col flex-1">
		<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
			<div class="container flex md:flex-row-reverse items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
				<!-- Mobile hamburger -->
				<button
